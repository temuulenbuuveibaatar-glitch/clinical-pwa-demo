...
// Simple in-memory users for demo. Replace with real DB in production.
...
// Simple medication import endpoint (admin only)
...
app.post('/api/import/medications', upload.single('file'), (req,res)=>{
  ...
  const out = path.join(__dirname,'..','data','medications.json');

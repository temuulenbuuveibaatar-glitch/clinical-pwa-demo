// Simple non-AI clinical decision support rule (sepsis triage checklist).
// Inputs: vitals object {hr, rr, sbp, temp, conf}
// Outputs: {severity: 'low|moderate|high', action, rationale}
// This is a simple rule demonstration only.
